              ...
              {(!currentUseState.isConnected) ?
                <Col lg="6" md="6" className="align-self-center">
                  ...
                  <a
                    ...
                    className="btn btn-success m-r-20 btn-md m-t-30 " style={{ backgroundColor: "#53575a" }}
                  >
                    Connect Wallet
                  </a>
                  <Link href={process.env.mainWWW}>
                    <a className="btn btn-md m-t-30  btn-outline-light " style={{ backgroundColor: "#02079e" }}>
                      Back Home
                    </a>
                  </Link>
                </Col> :
                  ...
                  {(currentUseState.isPrivateMintIsOpen) ?
                    <>
                      ...
                      {(process.env.enforceWhitelist == false || currentUseState.xmPower.isWhiteListed == true) ?
                        <>
                          {(currentUseState.isWaiting == false) ?
                            <>
                              <label className="connected">Number of Claimable All Mediks Club NFT's (1-{currentUseState.whiteListPass.q}):</label>
                              <div className="">
                      ...
                      <a
                        ...
                        className="btn btn-md m-t-30 btn-outline-light " style={{ backgroundColor: "#53575a" }}
